...
for step in range(iterations):
    ...
    m_first = [s_entropy[0], s_entropy[3], s_entropy[6], s_entropy[45], s_entropy[48]]
    m_middle = [s_entropy[1], s_entropy[4], s_entropy[7], s_entropy[46], s_entropy[49]]
    m_last = [s_entropy[2], s_entropy[5], s_entropy[8], s_entropy[47], s_entropy[50]]
