...
for step in range(iterations):
    ...
    m_first = [s_entropy[0], s_entropy[3], s_entropy[6], s_entropy[15], s_entropy[18]]
    m_middle = [s_entropy[1], s_entropy[4], s_entropy[7], s_entropy[16], s_entropy[19]]
    m_last = [s_entropy[2], s_entropy[5], s_entropy[8], s_entropy[17], s_entropy[20]]
