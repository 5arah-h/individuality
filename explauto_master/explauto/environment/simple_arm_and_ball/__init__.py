...
from .simple_arm_and_ball import SimpleArmEnvironment


def make_arm_config(m_ndims, m_max, s_mins, s_maxs, length_ratio, noise, diameter):
...
low_dim = make_arm_config(3, pi/3, array([-0.5, -1., -0.5, -1.]), array([1., 1., 1., 1.]), 3, 0.02, 0.1)
mid_dim = make_arm_config(7, pi/3, array([-0.5, -1., -0.5, -1.]), array([1., 1., 1., 1.]), 3./2., 0.02, 0.1)
hd_dim = make_arm_config(50, pi/12., array([-1., -1., -1., -1.]), array([1., 1., 1., 1.]), 1., 0.02, 0.1)
...
hd_dim_range = make_arm_config(50, pi/12., array([-2., -2.]), array([2., 2.]), 1., 0.02, 0.1)
