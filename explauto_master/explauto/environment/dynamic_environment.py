...
from explauto_master.explauto.models.dmp import DmpPrimitive
from explauto_master.explauto.utils.utils import bounds_min_max
...
class DynamicEnvironment(Environment):
    ...
    def update_arm_stick(self, arm_update, mstick_update):
        self.env.lower_env.lower_env.lower_env.holding = arm_update
        self.env.lower_env.lower_env.top_env.envs[0].holding = mstick_update
