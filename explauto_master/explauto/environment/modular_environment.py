...
class FlatEnvironment(Environment):
    ...
    def print_log(self):
        for i in range(self.n_envs):
            #print(self.envs_cls[i])
            self.envs[i].print_log()
...
class HierarchicalEnvironment(Environment):
    ...
    def print_log(self):
        #print(self.top_env_cls)
        self.top_env.print_log()
        #print(self.bottom_env_cls)
        self.lower_env.print_log()
