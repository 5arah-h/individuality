...
for step in range(iterations):
    ...
    if (step + 1) % intervall_measures == 0:
        ...
        organismal, colonial, env_det, env_coding, pid_data = compute_individuality(s_ns, s__ns, e_ns, min_s=min_m, max_s=max_m, min_e=min_s, max_e=max_s)
        print("iteration", step+1)
    ...
    m_first = [s_entropy[0], s_entropy[3], s_entropy[6], s_entropy[27], s_entropy[30]]
    m_middle = [s_entropy[1], s_entropy[4], s_entropy[7], s_entropy[28], s_entropy[31]]
    m_last = [s_entropy[2], s_entropy[5], s_entropy[8], s_entropy[29], s_entropy[32]]
